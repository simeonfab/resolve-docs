...
| **Number of defined roles** | 6 (Product Manager, Business Analyst, QA Tester, Implementation Engineer, Strategic Product Director, Technical Strategy Lead) | 12–21 depending on module (Analyst, PM, Architect, PO, Scrum Master, Dev, QA, Orchestrator, Tech Writer, +) | None as personas — uses phase-based commands, not role personas. |
